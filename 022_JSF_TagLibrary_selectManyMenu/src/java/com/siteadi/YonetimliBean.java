...
//----------------------------
    ...
    public YonetimliBean.Egitim[] egitimListesi;

    public YonetimliBean.Egitim[] getDil3Degeri() {
        egitimListesi = new YonetimliBean.Egitim[4];
        egitimListesi[0] = new YonetimliBean.Egitim("JAVA-JSP-JSF", "1400 TL");
        egitimListesi[1] = new YonetimliBean.Egitim("JAVA-ANDROID", "1100 TL");
        egitimListesi[2] = new YonetimliBean.Egitim("JAVA-GUI", "1200 TL");
        egitimListesi[3] = new YonetimliBean.Egitim("JAVA-ORACLE", "1000 TL");
