...
public class JDBCBaglantisi3_Update {
...
//---------------------------------------------	
    public static void main(String args[]) {
        JDBCBaglantisi3_Update nesne = new JDBCBaglantisi3_Update();
        nesne.veriOku();            
//---------------------------------------------			 
        nesne.veriDuzenle("Burak Çagatay", "Alkan", 
                "b.cagatay.alkan@facebook.com",
                "Bilgisayar Mühendisi", "3500", "4");
 //---------------------------------------------	
        nesne.veriOku();      
    }  
}
